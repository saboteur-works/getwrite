...
## Summary
- Total tasks: 20
- Total estimated effort: 65 points (was 62; Task 20 +3, appended 2026-09-26, Amended at Gate 6 by the user, to move the daily goal into a Writing Goals tab; earlier: was 59; Task 19 +3, appended 2026-09-26 to refresh the footer goal figure after a goal change; earlier: was 51; Task 17 +5 and Task 18 +3, appended at Gate 6 to replace the inline expandable footer with a writing-details overlay; earlier: Task 2 +1, Task 9 +2, Task 16 +2)
