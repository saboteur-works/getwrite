...
describe("a11y: Card primitive", () => {
    ...
    it("renders as article when as=article", () => {
        const { container } = render(
            <Card as="article" aria-label="resource card">Content</Card>,
        );
    ...
    it("renders as section when as=section", () => {
        const { container } = render(
            <Card as="section" aria-label="settings section">Content</Card>,
        );
    ...
    it("forwards aria attributes to the element", () => {
        const { container } = render(<Card aria-label="organizer card">Content</Card>);
        const el = container.firstChild as HTMLElement;
