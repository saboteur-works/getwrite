    ...
    function TestApp() {
      ...
      const handleOpen = (id?: string | null) => {
        ...
        if (p) {
          ...
          testStore.dispatch(setFolders(((p as any).folders ?? []) as any));
          testStore.dispatch(setResources((p.resources ?? []) as any));
        }
      };
      ...
      const currentResource =
        currentProject?.resources.find((r) => r.id === currentResourceId) ??
        null;
      ...
      React.useEffect(() => {
        if (currentProject) {
          ...
          testStore.dispatch(
            setFolders(((currentProject as any).folders ?? []) as any),
          );
          testStore.dispatch(
          ...
          {!currentProject ? (
            ...
            <div>
              ...
              <div data-testid="editor-area">
                {currentResource ? (
                  <EditView
                    initialContent={(currentResource.plainText ?? "") as string}
                  />
                ) : null}
              </div>
            </div>
