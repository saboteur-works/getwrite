...
describe("getUserPreferencesFromProjectMetadata — searchResultLimit", () => {
    it("returns undefined when metadata is absent", () => {
        expect(getUserPreferencesFromProjectMetadata(undefined).searchResultLimit).toBeUndefined();
    });

    it("returns undefined when userPreferences key is missing", () => {
        expect(getUserPreferencesFromProjectMetadata({}).searchResultLimit).toBeUndefined();
    });
    ...
    it("returns the stored number", () => {
        ...
        expect(getUserPreferencesFromProjectMetadata(metadata).searchResultLimit).toBe(25);
    });
    ...
    it("returns undefined for a string value", () => {
        ...
        expect(getUserPreferencesFromProjectMetadata(metadata).searchResultLimit).toBeUndefined();
    });
...
describe("mergeUserPreferencesIntoProjectMetadata — searchResultLimit round-trip", () => {
    ...
    it("overwrites an existing searchResultLimit", () => {
        ...
        expect(getUserPreferencesFromProjectMetadata(merged).searchResultLimit).toBe(100);
    });
});
