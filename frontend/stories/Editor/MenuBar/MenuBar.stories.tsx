...
export const Default: Story = {
  render: (args: React.ComponentProps<typeof MenuBar>) => (
    <div>
      <MenuBar {...args} />
      <div data-testid="editor-loaded" aria-hidden style={{ display: "none" }}>
        true
      </div>
    </div>
  ),
  args: { editor: defaultEditor, stateOverride: defaultState },
};
  ...
  render: (args: React.ComponentProps<typeof MenuBar>) => {
    ...
    return (
      <div>
        ...
        <div data-testid="action-count" aria-hidden style={{ display: "none" }}>
          {actionCount}
        </div>
      </div>
    );
