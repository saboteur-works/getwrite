...
export const Default: Story = {
  render: (args: DiffViewProps) => (
    <div>
      <DiffView {...args} />
      <div data-testid="revision-count" aria-hidden style={{ display: "none" }}>
        {String(args.revisions?.length ?? 0)}
      </div>
      <div data-testid="has-content" aria-hidden style={{ display: "none" }}>
...
export const Empty: Story = {
  ...
  args: { canonicalContent: "", selectedContent: undefined, revisions: [] },
};
...
export const LoadingStates: Story = {
  args: { isLoadingCanonical: true, isLoadingRevisions: true, revisions: [] },
};
...
export const Interactive: Story = {
  ...
  args: { canonicalContent: canonicalText, revisions },
};
