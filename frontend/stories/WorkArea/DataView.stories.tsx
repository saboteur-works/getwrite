...
export const Default: Story = { args: { project } };
...
export const WithResources: Story = {
  render: (args: DataViewProps) => (
    <div>
      <DataView {...args} />
      <div data-testid="resource-count" aria-hidden style={{ display: "none" }}>
        {String(args.resources?.length ?? 0)}
      </div>
    </div>
  ),
  args: { project, resources: resources },
};
...
export const Interactive: Story = {
  render: (args: DataViewProps) => {
    ...
    return (
      <div>
        <DataView {...args} onResourceClick={(id) => setSelectedId(id)} />
        <div
