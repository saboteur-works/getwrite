...
export const BooleanField: Story = {
  ...
  render: (args: React.ComponentProps<typeof ValuePicker>) => (
...
export const ResourceRefField: Story = {
  args: {
    ...
    operator: "is",
    value: { id: "aaaaaaaa-0000-0000-0000-000000000001", name: "Mara" },
...
export const HoverPreviewStory: StoryObj<typeof RefHoverPreview> = {
  ...
  render: () => (
    <div
      style={{ padding: 32, display: "flex", gap: 16, alignItems: "center" }}
    >
      <RefHoverPreview
      ...
      <RefHoverPreview resource={{ id: null, name: "Deleted Character" }}>
        <span
          style={{
            fontFamily: "monospace",
            fontSize: 10,
  ...
  args: { resource: { id: "test", name: "Test" }, children: null },
};
...
export const Interactive: Story = {
  ...
  render: (args: React.ComponentProps<typeof ValuePicker>) => {
    ...
    return (
      ...
      >
        <ValuePicker {...args} value={value} onChange={setValue} />
    ...
    return (
      ...
      >
        <p style={{ fontFamily: "monospace", fontSize: 11, opacity: 0.5 }}>
          Type "m" or "j" to see suggestions. Hover the chip to see the preview.
        </p>
        <ValuePicker {...args} value={value} onChange={setValue} />
        <pre style={{ fontFamily: "monospace", fontSize: 11, opacity: 0.5 }}>
          {JSON.stringify(value, null, 2)}
