...
const GROUP_B_CHIPS: GroupChip[] = [
    { id: "b1", field: FIELDS[5], operator: "in-the-last", value: { amount: 7, unit: "days" } },
    ...
    render: (args) => {
                ...
                setGroups((prev) =>
                    prev.map((g) =>
                        g.id !== groupId
                            ...
                            : {
                                  ...g,
                                  chips: g.chips.filter((c) => c.id !== chipId),
                              },
                    ),
                );
            },
        ...
        return (
            ...
            >
                ...
                >
                    Toggle the combinator pill · Add/delete groups · Edit
                    chips. Match count updates as chips change.
                </p>
                <QueryBuilder
                    groups={groups}
                    globalCombinator={globalCombinator}
