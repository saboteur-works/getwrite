...
const axisBounds = { start: d("2024-01-01"), end: d("2024-04-30") };
...
export const WithDuration: Story = {
  render: () => (
    <div className="p-4 bg-gw-chrome">
      <TimelineRow
        items={[
          scene("1", "Long arc", "2024-01-05", { endDate: "2024-02-15" }),
          scene("2", "Short scene", "2024-03-01", { endDate: "2024-03-03" }),
...
export const Empty: Story = {
  render: () => (
    <div className="p-4 bg-gw-chrome">
      <TimelineRow items={[]} axisBounds={axisBounds} {...rowProps} />
    </div>
  ),
};
