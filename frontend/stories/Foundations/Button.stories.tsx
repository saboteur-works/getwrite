...
export const Outline: Story = {
  args: { variant: "outline", size: "md", children: "Confirm" },
};

export const Secondary: Story = {
  args: { variant: "secondary", size: "sm", children: "Cancel" },
};

export const Default: Story = {
  args: { variant: "default", size: "sm", children: "Save Changes" },
};
...
export const ActionXs: Story = {
  args: { variant: "secondary", size: "xs", children: "Add Field" },
};
