...
export const Density: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "UI density is applied via the gw-density-compact class. Compare spacing and sizing between comfortable (default) and compact modes. Toggle the toolbar color mode to verify both densities maintain token consistency across light and dark modes.",
      },
    },
  },
};
