    ...
    render: () => (
        <div className="flex flex-col gap-4 p-6 bg-gw-bg min-h-screen">
            ...
            <Card variant="chrome" padding="md">
                <p className="text-sm text-gw-primary">Chrome card — primary panel surface</p>
                <p className="mt-1 text-xs text-gw-secondary">bg-gw-chrome with border</p>
            </Card>
            ...
            <Card variant="chrome2" padding="md">
                <p className="text-sm text-gw-primary">Chrome2 card — nested / stat surface</p>
                <p className="mt-1 text-xs text-gw-secondary">bg-gw-chrome2 with border</p>
            </Card>
            ...
            <Card as="article" variant="chrome" padding="md" aria-label="sample resource card">
                <p className="text-sm font-medium text-gw-primary">Chapter One</p>
                <p className="mt-1 text-xs text-gw-secondary">text file · 2 450 words</p>
            </Card>
        </div>
    ),
    args: {},
