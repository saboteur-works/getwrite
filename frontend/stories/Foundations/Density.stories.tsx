  ...
  return (
    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "160px 1fr" }}>
        <div style={{ borderRight: "0.5px solid var(--color-gw-border)" }}>
          <div
            ...
            {["Chapter 01", "Chapter 02", "Chapter 03"].map((name, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "0 12px",
                  backgroundColor:
                    i === 0 ? "var(--color-gw-chrome2)" : undefined,
                  borderLeft:
                    i === 0
...
function DensityShowcase(): JSX.Element {
  return (
    <div style={{ maxWidth: 640 }}>
      ...
      >
        GetWrite supports two density modes. Comfortable is the default. Compact
        reduces chrome bar heights and padding, controlled by the
        .gw-density-compact class applied to the root container.
      </p>
