...
export const SidebarDefault: Story = {
    args: {
        ...
        variant: "sidebar",
        children: (
            <div className="text-sm text-gw-secondary mt-2">Synopsis textarea would appear here.</div>
        ),
    },
};
...
export const SidebarCollapsed: Story = {
    args: {
        ...
        defaultOpen: false,
        children: (
            <div className="text-sm text-gw-secondary mt-2">Tag chips would appear here.</div>
        ),
    },
};
    ...
    render: () => (
        <div className="w-64 p-4 border border-gw-border rounded">
            ...
            <CollapsibleSection title="Story Details" variant="sidebar">
                <div className="text-sm text-gw-secondary mt-2">Date and duration fields here.</div>
            </CollapsibleSection>
