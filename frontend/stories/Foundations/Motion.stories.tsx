...
function ReducedMotionDemo(): JSX.Element {
    ...
    return (
        <div style={{ padding: "20px 0", borderBottom: "0.5px solid var(--color-gw-rule)" }}>
            <div className={enabled ? "gw-reduced-motion" : undefined} style={{ display: "flex", gap: 32, alignItems: "center" }}>
                <div
                    onMouseEnter={(e) => { (e.currentTarget as HTMLDivElement).style.backgroundColor = "var(--color-gw-chrome2)"; }}
                    onMouseLeave={(e) => { (e.currentTarget as HTMLDivElement).style.backgroundColor = "var(--color-gw-chrome)"; }}
                    style={{
                        width: 200,
                        height: 48,
                ...
                >
                    <span style={{ fontFamily: "var(--font-mono)", fontSize: 10, textTransform: "uppercase", letterSpacing: "0.14em", color: "var(--color-gw-secondary)" }}>
                        Hover me
                    </span>
                </div>
                <div>
            ...
            <div style={{ marginTop: 16, display: "flex", alignItems: "center", gap: 10 }}>
                <button
                    ...
                    style={{
                        ...
                        textTransform: "uppercase",
                        letterSpacing: "0.14em",
                        color: enabled ? "var(--color-gw-primary)" : "var(--color-gw-secondary)",
                        backgroundColor: enabled ? "var(--color-gw-chrome2)" : "transparent",
                        border: "0.5px solid var(--color-gw-border)",
...
function MotionShowcase(): JSX.Element {
    return (
        <div style={{ maxWidth: 640 }}>
            ...
            <div style={{ borderTop: "0.5px solid var(--color-gw-border)", marginBottom: 48 }}>
            ...
            <p style={{ fontFamily: "var(--font-sans)", fontSize: 12, color: "var(--color-gw-secondary)", margin: "0 0 16px", lineHeight: 1.5 }}>
                The .gw-reduced-motion class collapses all animation and transition durations to 0.01ms. Applied by the user preferences system when reduced motion is enabled. Also respected via the prefers-reduced-motion media query.
            </p>
