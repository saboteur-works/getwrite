...
const meta: Meta<typeof Chip> = { title: "Common/Chip", component: Chip };
...
export const Default: Story = {
  args: { label: "Draft", shape: "sharp", size: "md" },
};

export const WithColor: Story = {
  args: { label: "Fiction", shape: "sharp", size: "md", color: "#6b8cae" },
};

export const SharpVsRounded: Story = {
  args: { label: "Sharp", shape: "sharp", size: "md" },
  render: (args: React.ComponentProps<typeof Chip>) => (
...
export const WithTooltip: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Hover the chip to see the tooltip. Both `tooltip` and `tooltipId` must be provided — omitting either suppresses the tooltip.",
      },
    },
  },
};
