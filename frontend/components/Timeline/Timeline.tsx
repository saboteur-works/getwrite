...
export default function Timeline({
    ...
    const rows = React.useMemo(() => {
        if (!groups || groups.length === 0) {
            return [{ group: undefined as TimelineGroup | undefined, items: filteredItems }];
        }
        ...
        >
            ...
            {showLegend && (
                <div className="timeline-legend">
                    <div style={{ width: labelWidth + 16, minWidth: labelWidth + 16, flexShrink: 0 }} />
                        ...
                        >
                            ...
                            <span
                                style={{
                                    ...
                                    color: "var(--timeline-row-separator)",
                                    userSelect: "none",
                                }}
                            >
                                {activePoV
