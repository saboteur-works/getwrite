    ...
    >
      <div className="help-header">
        <div className="help-header-copy">
          <h2 id={HELP_DIALOG_TITLE_ID} className="help-title help-heading">
            Help &amp; Documentation
          </h2>
          <p className="help-subtitle help-label">Learn how to use GetWrite</p>
        </div>
        {onClose ? (
          <Button
            ref={closeButtonRef}
      ...
      <div className="help-body">
        <nav className="help-nav" role="tablist" aria-label="Help sections">
          {HELP_TABS.map((tab) => (
            <button
              key={tab.id}
              id={`help-tab-${tab.id}`}
