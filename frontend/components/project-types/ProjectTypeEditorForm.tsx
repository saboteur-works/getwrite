...
export default function ProjectTypeEditorForm({
    ...
    type BodyConfig = NonNullable<NonNullable<ProjectTypeDefinition["editorConfig"]>["body"]>;
        ...
        <div className="project-type-editor-form">
            ...
            <section className="project-type-editor-section">
                ...
                <p className="project-type-editor-helper-text">
                    ...
                    include a folder named &ldquo;Workspace&rdquo;.
                </p>
                            ...
                            >
                                <div className="project-type-editor-form-grid project-type-editor-form-grid--three-column">
                                    <LabeledInput
                                        ...
                                        onChange={(value) =>
                                            patchResource(index, { name: value })
                                        }
                                    />
                                    <LabeledInput
                                        label="Folder"
            ...
            <section className="project-type-editor-section">
                ...
                <div className="project-type-editor-stack">
                    ...
                    <p className="project-type-editor-helper-text">
                        Custom styles applied to each heading level in the
                        editor.
                    </p>
                    ...
                    <div className="project-type-editor-card">
                        <div className="project-type-editor-form-grid project-type-editor-form-grid--four-column">
                            <LabeledInput
                                label="Font Family"
                                value={
                                    definition.editorConfig?.body?.fontFamily ??
                                    ""
                                }
                            ...
                            <LabeledNumberInput
                                ...
                                value={
                                    definition.editorConfig?.body?.fontSize
                                        ? definition.editorConfig.body.fontSize.replace(
                                              "px",
                                              "",
                                          )
                                        : ""
                            ...
                            <LabeledInput
                                label="Line Height"
                                value={
                                    definition.editorConfig?.body?.lineHeight ??
                                    ""
                                }
                                placeholder="1.8"
                                onChange={(value) =>
                            ...
                            <LabeledInput
                                ...
                                onChange={(value) =>
                                    patchBody({
                                        paragraphSpacing: value || undefined,
                                    })
                                }
                            />
                        </div>
    ...
    return (
        <label className="project-type-editor-field">
            ...
            <div className="project-type-editor-color-row">
                ...
                />
                <span className="project-type-editor-color-value">
                    {value || ""}
                </span>
            </div>
        </label>
