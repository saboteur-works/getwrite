...
export const selectResolvedEditorConfig = createSelector(
  (state: { editorConfig: EditorConfigState }) => state.editorConfig,
  (stored): { headings: EditorHeadingMap; body: EditorBodyConfig } => {
