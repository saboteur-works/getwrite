...
/**
 * Tracks whether a main-process-initiated DOCX import has reached a terminal
 * outcome yet, independent of whatever the renderer believes.
 *
 ...
 * from `electron/src/scrivener-import/import-guard.ts`, which this file
