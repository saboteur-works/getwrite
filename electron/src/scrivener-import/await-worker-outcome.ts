...
/**
 * Races a forked Scrivener import worker's terminal outcome against it
 * exiting or erroring before ever posting one.
 *
 ...
 * `main.ts`, that would also permanently wedge the FR-6 single-import guard,
 * since its `finish()` call is chained off the same await. This module gives
