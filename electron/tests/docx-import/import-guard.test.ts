...
/**
 * The main-process half of the DOCX import start/finish guard: it must
 * refuse a second concurrent import and must reopen once the first one
 * finishes. Mirrors `electron/tests/scrivener-import/import-guard.test.ts`'s
 * own coverage shape against the DOCX-specific module.
 */
import { describe, it, expect } from "vitest";
import { createImportGuard } from "../../src/docx-import/import-guard";
